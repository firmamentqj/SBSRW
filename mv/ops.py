...
def load_sketchhead(sketch_head, weights_file):
    ...
    sketch_head.load_state_dict(checkpoint['sketch_head'])
...
def load_checkpoint(setup, models_bag,sketch_head, weights_file):
    ...
    # models_bag["lr_scheduler"].load_state_dict(checkpoint['lr_scheduler'])
